...
"""
Text in the primes.pyf cannot contain ANY upper case characters.
...
def error(i,line):
    print("ERROR : No code related characters in primes.pyf cannot contain upper case characters")
    print("ERROR : Uppercase found in primes.pyf line {0:d}. String found is: {1:s} ".format(i,line))
    sys.exit(1)
